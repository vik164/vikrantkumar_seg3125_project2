                ...
                <Row>
                    ...
                    <Col md={4}>
                        <div className="p-2 text-center" style={{textalign: 'center',  backgroundcolor: 'black'}}>
                            ...
                            <a href="/Home" style={{textalign: 'center', fontFamily:"serif"}}>Home</a> <br></br> 
                            <a href="/Services" style={{textalign: 'center', fontFamily:"serif"}}>Services</a> <br></br> 
                            <a href="/Vehicles" style={{textalign: 'center', fontFamily:"serif"}}>Vehicles</a> <br></br> 
                            <a href="/Contact" style={{textalign: 'center', fontFamily:"serif"}}>Contact Us</a> <br></br> 
                        </div>
                    </Col> 
                </Row>
            </Container>
