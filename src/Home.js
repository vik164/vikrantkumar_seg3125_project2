...
const HomePage = () => {
    return (  
        <div className="home">
            <div className="part1">
                <Container fluid style={{marginTop:20, backgroundColor:"#212529", height:"600", width:"50"}}>
                    <Container xxl>
                        <Carousel>
                            <Carousel.Item>
                ...
                <Container fluid style={{marginTop:20, backgroundColor:"#212529", textalign:'center'}}>
                    ...
                    <Row className='justify-content-center'>
                        <Col md={true} className='text-center'>
                            <Button size='lg' style={{width:'80%', itemalign:'center', marginBottom:30}}>Vehicles</Button>
                        </Col>

                        <Col md={true} className='text-center'>
                            <Button size='lg' style={{width:'80%', itemalign:'center', marginBottom:30}}>Reserve Now</Button>
                        </Col>
                    </Row>
                </Container>
            </div>
                ...
                <Container fluid style={{marginTop:20, backgroundColor:"#212529", textalign:'center'}}>
                    <Row>
                        ...
                        <Col md={true} style={{textAlign:'center'}}>
                            ...
                            <Button variant="outline-light" style={{margin:10, fontFamily:"serif"}}>View Services</Button>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={true} style={{textAlign:'center'}}>
                            ...
                            <p style={{color:'white', textAlign:'center', marginTop:25, fontFamily:"serif"}}>Dominari stagna vultus terris descenderat ignea semina hanc regna duae verba eodem discordia perveniunt mortales chaos: porrexerat undae lege mare emicuit moderantum nubes habitabilis exemit origo levius figuras quod sponte terrarum cum egens pressa egens flamma rapidisque sic caeca vix alto coeptis corpora.</p>
                            <Button variant="outline-light" style={{margin:10, fontFamily:"serif"}}>View Vehicles</Button>
                        </Col>
                        <Col md={true}>
                    ...
                    <Row>
                        ...
                        <Col md={true} style={{textAlign:'center'}}>
                            ...
                            <p style={{color:'white', textAlign:'center', marginTop:25, fontFamily:"serif"}}>Dominari stagna vultus terris descenderat ignea semina hanc regna duae verba eodem discordia perveniunt mortales chaos: porrexerat undae lege mare emicuit moderantum nubes habitabilis exemit origo levius figuras quod sponte terrarum cum egens pressa egens flamma rapidisque sic caeca vix alto coeptis corpora.</p>
                            <Button variant="outline-light" style={{margin:10, fontFamily:"serif"}}>Contact Us</Button>
                        </Col>
                    </Row>
                </Container>
            </div>
